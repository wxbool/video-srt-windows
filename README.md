...
##### 下载地址:(v0.1.5)
* .zip（含ffmpeg依赖） [点我下载](http://file.viggo.site/video-srt/0.1.5/video-srt-gui-ffmpeg-0.1.5-x64.zip)
* .zip（不含ffmpeg依赖） [点我下载](http://file.viggo.site/video-srt/0.1.5/video-srt-gui-0.1.5-x64.zip)
