...
<a name="e66a66f1"></a>
##### 下载地址:
- (v0.2.9.2)（含ffmpeg依赖） [点我下载](http://file.viggo.site/video-srt/0.2.9.2/video-srt-gui-ffmpeg-0.2.9.2-x64.zip)
- (v0.2.9.2)（不含ffmpeg依赖） [点我下载](http://file.viggo.site/video-srt/0.2.9.2/video-srt-gui-0.2.9.2-x64.zip)
